...
class QLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            agent_outs, hidden_state_= self.mac.forward(batch, t=t, hidden_states = self.hidden_state)
        ...
        for t in range(batch.max_seq_length):
            target_agent_outs, target_hidden_state_ = self.target_mac.forward(batch, t=t, hidden_states = self.target_hidden_state)
            self.target_hidden_state = target_hidden_state_
    ...
    def mix_value(self, chosen_action_qvals, state):
