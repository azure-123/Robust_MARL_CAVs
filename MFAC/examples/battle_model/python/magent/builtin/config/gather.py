""" battle nad gather of two armies """

import magent

#  small = cfg.register_agent_type(
#         name="small",
#         attr={'width': 1, 'length': 1, 'hp': 9, 'speed': 3,
#               'view_range': gw.CircleRange(7), 'attack_range': gw.CircleRange(1),
#               'damage': 6, 'step_recover': 0,  'kill_reward': 1,
...
def get_config(map_size):
    ...
    cfg.add_reward_rule(gw.Event(b, 'attack', c), receiver=b, value=0.5)
