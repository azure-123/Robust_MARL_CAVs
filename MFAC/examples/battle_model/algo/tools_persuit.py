...
class Runner(object):
    ...
    def run(self, variant_eps, iteration, eps_attack, win_cnt=None , kill_cnt=None,total_reward=None, kill_list=None, reward_list=None):
        ...
        if self.train:
            ...
            kill_list['main'].append(info['main']['alive'])
            kill_list['opponent'].append(info['opponent']['alive'])
            reward_list['main'].append(info['main']['total_reward'])
            reward_list['opponent'].append(info['opponent']['total_reward'])

            kill_cnt['main'] += info['main']['alive']
            kill_cnt['opponent'] += info['opponent']['alive']
